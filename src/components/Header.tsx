...
const navItems: NavItem[] = [
  { label: "Home", href: "/" },
  {
    ...
    hasMegaMenu: true,
    children: [
      { label: "Wrestling team shows determination", href: "#" },
      { label: "Fans celebrate dramatic goal", href: "#" },
      { label: "Star swimmer sets record", href: "#" },
      { label: "Table tennis prodigy stuns", href: "#" },
      { label: "Rugby captain praises unity", href: "#" },
      { label: "National tennis champion advances", href: "#" },
    ],
  },
  {
    label: "Sports",
    hasMegaMenu: true,
    children: [
      { label: "Breaking sports news faster", href: "#" },
      { label: "Star striker leads comeback", href: "#" },
      { label: "Local stadium record attendance", href: "#" },
      { label: "Track and field preparations", href: "#" },
    ],
  },
  {
    label: "Pages",
...
const tickerNews = [
  "Breaking sports news faster than ever",
  "Star striker leads late comeback as home team secures",
  "National tennis champion advances to finals after dominating",
  "Rising basketball rookie earns praise from coaches",
  "Local football club strengthens playoff chances",
  "Veteran cricket bowler announces return to form as team",
];

const tags = [
  "Makeup", "Gaming", "Food", "Business", "Branding", "Beauty",
  "Marketing", "Politics", "Printing", "Social", "Sports", "Technology",
  "Travel", "Trip",
];
                    ...
                    <div className="offcanvas-container">
                      ...
                      <div className="offcanvas-content" style={{ padding: "80px 50px 50px" }}>
                        <div className="offcanvas-logo">
                          <Link href="/">
                            <Image src="/assets/images/logo.png" alt="Sports News" width={180} height={35} style={{ height: 35, width: "auto" }} />
                          </Link>
                        </div>
                        ...
                        <div className="offcanvas-gallery">
                          <a href="#"><img src="https://nerio.rstheme.com/sports-news/wp-content/uploads/sites/6/2025/09/sport_31-min-150x150.jpg" alt="Sport 31" width={150} height={150} /></a>
                          <a href="#"><img src="https://nerio.rstheme.com/sports-news/wp-content/uploads/sites/6/2025/10/sport_30-min-150x150.jpg" alt="Sport 30" width={150} height={150} /></a>
                          <a href="#"><img src="https://nerio.rstheme.com/sports-news/wp-content/uploads/sites/6/2025/10/sport_29-min-150x150.jpg" alt="Sport 29" width={150} height={150} /></a>
                          <a href="#"><img src="https://nerio.rstheme.com/sports-news/wp-content/uploads/sites/6/2025/10/sport_28-min-150x150.jpg" alt="Sport 28" width={150} height={150} /></a>
                          <a href="#"><img src="https://nerio.rstheme.com/sports-news/wp-content/uploads/sites/6/2025/10/sport_26-min-150x150.jpg" alt="Sport 26" width={150} height={150} /></a>
                          <a href="#"><img src="https://nerio.rstheme.com/sports-news/wp-content/uploads/sites/6/2025/10/sport_21-min-150x150.jpg" alt="Sport 21" width={150} height={150} /></a>
                        </div>
            ...
            <div className="nerio-container">
              <div className="header-top-inner" style={{ minHeight: 70 }}>
                ...
                <div className="flex items-center gap-3 header-actions-desktop">
                  ...
                  <div className="rstb-offcanvas-wrap hidden lg:block">
                    <div className="offcanvas-toggle-wrap">
                      <button className="offcanvas-toggle" aria-label="Menu">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 18">
                          <path d="M6 1.8001C6 1.13738 6.53728 0.600098 7.2 0.600098H22.8C23.4627 0.600098 24 1.13738 24 1.8001C24 2.46282 23.4627 3.0001 22.8 3.0001H7.2C6.53728 3.0001 6 2.46277 6 1.8001ZM22.8 7.8001H1.2C0.537281 7.8001 0 8.33743 0 9.0001C0 9.66282 0.537281 10.2001 1.2 10.2001H22.8C23.4627 10.2001 24 9.66282 24 9.0001C24 8.33743 23.4627 7.8001 22.8 7.8001ZM22.8 15.0001H12C11.3373 15.0001 10.8 15.5374 10.8 16.2001C10.8 16.8628 11.3373 17.4001 12 17.4001H22.8C23.4627 17.4001 24 16.8628 24 16.2001C24 15.5374 23.4627 15.0001 22.8 15.0001Z" />
                        </svg>
                      </button>
